...
const BOOKS = [
  {
    img: `/next-tailwind/image/books/RectangleBig1.svg`,
  ...
  {
    img: `/next-tailwind/image/books/RectangleBig6.svg`,
  ...
  {
    img: `/next-tailwind/image/books/RectangleBig2.svg`,
  ...
  {
    img: `/next-tailwind/image/books/RectangleBig3.svg`,
  ...
  {
    img: `/next-tailwind/image/books/RectangleBig4.svg`,
  ...
  {
    img: `/next-tailwind/image/books/RectangleBig5.svg`,
    category: "William Strunk Jr.",
    title: "The Elements of Style",
    desc: "A classic reference book on grammar and writing skills, essential for high school and college students.",
    price: "$99",
