        ...
        <div className="mt-40 grid gap-6 lg:mt-0">
          <div className="grid grid-cols-4 gap-6">
            <Image
              width={768}
              height={768}
              src="/next-tailwind/image/books/Rectangle8.svg"
            ...
            <Image
              width={768}
              height={768}
              src="/next-tailwind/image/books/Rectangle9.svg"
            ...
            <Image
              width={768}
              height={768}
              src="/next-tailwind/image/books/Rectangle10.svg"
            ...
            <Image
              width={768}
              height={768}
              src="/next-tailwind/image/books/Rectangle11.svg"
          ...
          <div className="grid grid-cols-4 gap-6">
            ...
            <Image
              width={768}
              height={768}
              src="/next-tailwind/image/books/Rectangle12.svg"
              className="-mt-28 rounded-lg shadow-md"
              alt="flowers"
            />
            <Image
              width={768}
              height={768}
              src="/next-tailwind/image/books/Rectangle13.svg"
              className="-mt-14 rounded-lg shadow-md"
              alt="flowers"
            />
            <Image
              width={768}
              height={768}
              src="/next-tailwind/image/books/Rectangle14.svg"
              className="-mt-20 rounded-lg shadow-md"
              alt="flowers"
            />
          </div>
